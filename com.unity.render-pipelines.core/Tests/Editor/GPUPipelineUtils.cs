...
namespace UnityEngine.Rendering.Tests
{
    ...
    internal struct ClusterCullingResultsCPUReadbackData : IDisposable
    {
            ...
            GraphicsBuffer visibleClusterBuffer)
        {
            ...
            var tmpVisibleIndexData = new NativeArray<int>((int)drawArgs.indexCount, Allocator.Persistent);
            ...
            var tmpVisibleClusterData = new NativeArray<int>((int)drawArgs.indexCount / (3 * GeometryPoolConstants.GeoPoolClusterPrimitiveCount), Allocator.Persistent);
